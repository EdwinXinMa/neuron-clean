...
import com.echarge.common.constant.enums.FileTypeEnum;
...
import com.echarge.common.system.vo.SysFilesModel;
...
import com.echarge.modules.system.entity.SysComment;
import com.echarge.modules.system.entity.SysFormFile;
import com.echarge.modules.system.mapper.SysCommentMapper;
import com.echarge.modules.system.mapper.SysFormFileMapper;
import com.echarge.modules.system.service.ISysCommentService;
import com.echarge.modules.system.vo.SysCommentFileVo;
import com.echarge.modules.system.vo.SysCommentVO;
import com.echarge.modules.system.vo.UserAvatar;
...
//    private IEasyOaBaseApi easyOaBseApi;
    ...
    @Value(value = "${neuron.path.upload}")
    private String uploadpath;

    @Value(value = "${neuron.uploadType}")
    ...
    public void saveOneFileComment(HttpServletRequest request) {
        ...
        if(oConvertUtils.isEmpty(existFileId)){
            ...
            try {
                ...
                throw new NeuronBootException(e);
            }

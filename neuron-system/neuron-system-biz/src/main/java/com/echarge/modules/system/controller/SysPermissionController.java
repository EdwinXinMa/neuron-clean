...
import com.echarge.common.util.Md5Util;
...
import com.echarge.modules.system.model.SysPermissionTree;
import com.echarge.modules.system.model.TreeModel;
import com.echarge.modules.system.service.*;
import com.echarge.modules.system.util.PermissionDataUtil;
...
*/
			...
			//数据源安全模式
			json.put("sysSafeMode", neuronBaseConfig.getFirewall()!=null? neuronBaseConfig.getFirewall().getDataSourceSafe(): false);
	...
	public Result<?> getPermCode() {
		try {
            ...
            //数据源安全模式
			result.put("sysSafeMode", neuronBaseConfig.getFirewall()!=null? neuronBaseConfig.getFirewall().getDataSourceSafe(): null);

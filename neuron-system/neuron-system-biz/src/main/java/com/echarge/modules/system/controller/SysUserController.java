...
import com.echarge.common.aspect.annotation.PermissionData;
...
import com.echarge.common.modules.redis.client.NeuronRedisClient;
...
import com.echarge.modules.system.excelstyle.ExcelExportSysUserStyle;
...
import com.echarge.modules.system.vo.SysDepartUsersVO;
import com.echarge.modules.system.vo.SysUserExportVo;
import com.echarge.modules.system.vo.SysUserRoleVO;
...
public class SysUserController {
    ...
    @Autowired
    private NeuronRedisClient jeecgRedisClient;
    @Autowired
...
//	}
   ...
   /**
    ...
    public Result<String> verifyIzDefaultPwd() throws UnsupportedEncodingException {
        ...
        if (neuronBaseConfig.getFirewall() == null || Boolean.FALSE.equals((neuronBaseConfig.getFirewall().getEnableDefaultPwdCheck()))) {
            return Result.OK("no");
        }

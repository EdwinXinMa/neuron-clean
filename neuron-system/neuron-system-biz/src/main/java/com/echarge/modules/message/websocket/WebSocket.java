package com.echarge.modules.message.websocket;
...
public class WebSocket {
    ...
    //避免初次调用出现空指针的情况
    private static NeuronRedisClient jeecgRedisClient;
    @Autowired
    private void setNeuronRedisClient(NeuronRedisClient jeecgRedisClient){

package com.echarge.modules.quartz.service.impl;
...
import com.echarge.modules.quartz.entity.QuartzJob;
import com.echarge.modules.quartz.mapper.QuartzJobMapper;
import com.echarge.modules.quartz.service.IQuartzJobService;
import org.quartz.*;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
	 ...
	 */
	@Override
	@Transactional(rollbackFor = NeuronBootException.class)
	...
	private void schedulerAdd(String id, String jobClassName, String cronExpression, String parameter) {
		try {
			...
			throw new NeuronBootException("创建定时任务失败", e);
		} catch (RuntimeException e) {
			throw new NeuronBootException(e.getMessage(), e);
		}catch (Exception e) {
			throw new NeuronBootException("后台找不到该类名：" + jobClassName, e);
		}
	}
	...
	private void schedulerDelete(String id) {
		try {
			...
			throw new NeuronBootException("删除定时任务失败");
		}
	}

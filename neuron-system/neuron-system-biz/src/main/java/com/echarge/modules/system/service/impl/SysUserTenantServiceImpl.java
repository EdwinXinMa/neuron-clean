...
import com.echarge.modules.system.entity.SysTenant;
import com.echarge.modules.system.entity.SysUser;
import com.echarge.modules.system.entity.SysUserTenant;
import com.echarge.modules.system.mapper.SysTenantPackUserMapper;
import com.echarge.modules.system.mapper.SysUserMapper;
import com.echarge.modules.system.mapper.SysUserPositionMapper;
...
public class SysUserTenantServiceImpl extends ServiceImpl<SysUserTenantMapper, SysUserTenant> implements ISysUserTenantService {
    ...
    public void updateUserTenantStatus(String id, String tenantId, String userTenantStatus) {
        if (oConvertUtils.isEmpty(tenantId)) {
            throw new NeuronBootException("租户数据为空");
        }

...
@Slf4j
public class SysCommentController extends NeuronController<SysComment, ISysCommentService> {
     ...
     * 在线预览文件地址
     */
    @Value("${neuron.file-view-domain}/onlinePreview")
    ...
    //@RequiresPermissions("com.echarge.modules.demo:sys_comment:add")
    ...
    //@RequiresPermissions("com.echarge.modules.demo:sys_comment:edit")
    ...
    @Operation(summary = "系统评论回复表-通过id删除")
    //@RequiresPermissions("com.echarge.modules.demo:sys_comment:delete")
    ...
    //@RequiresPermissions("com.echarge.modules.demo:sys_comment:deleteBatch")
     ...
     * @param sysComment
     */
    //@RequiresPermissions("com.echarge.modules.demo:sys_comment:exportXls")

...
import com.echarge.common.util.UUIDGenerator;
...
import com.echarge.modules.system.mapper.SysRoleMapper;
import com.echarge.modules.system.mapper.SysThirdAccountMapper;
    ...
    public SysThirdAccount bindThirdAppAccountByUserId(SysThirdAccount sysThirdAccount) {
        ...
        if(null != oneByThirdUserId){
            ...
            if(oConvertUtils.isNotEmpty(oneByThirdUserId.getSysUserId()) && oneByThirdUserId.getSysUserId().equals(sysUser.getId())){
                ...
                throw new NeuronBootException("该敲敲云账号已被其它第三方账号绑定,请解绑或绑定其它敲敲云账号");
            }else{
                //更新第三方表信息用户id
            ...
            throw new NeuronBootException("账号绑定失败,请稍后重试");
        }
    }

...
import com.echarge.common.constant.TenantConstant;
...
import com.echarge.modules.system.entity.SysPackPermission;
import com.echarge.modules.system.entity.SysTenantPack;
import com.echarge.modules.system.entity.SysTenantPackUser;
...
public class SysTenantPackServiceImpl extends ServiceImpl<SysTenantPackMapper, SysTenantPack> implements ISysTenantPackService {
    ...
    public void izHaveManageUserAuth(String tenantId) {
        ...
        if(count == 0){
            throw new NeuronBootBizTipException("你不是当前租户的组织账户管理员或超级管理员，无法进行此操作！");
        }
    }
}

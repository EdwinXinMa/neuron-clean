...
import com.echarge.modules.system.entity.SysPermission;
import com.echarge.modules.system.entity.SysPermissionDataRule;
import com.echarge.modules.system.entity.SysRoleIndex;
import com.echarge.modules.system.mapper.SysDepartPermissionMapper;
import com.echarge.modules.system.mapper.SysDepartRolePermissionMapper;
import com.echarge.modules.system.mapper.SysPermissionMapper;
import com.echarge.modules.system.mapper.SysRolePermissionMapper;
import com.echarge.modules.system.model.TreeModel;
import com.echarge.modules.system.service.ISysPermissionDataRuleService;
import com.echarge.modules.system.service.ISysPermissionService;
import com.echarge.modules.system.service.ISysRoleIndexService;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	public void deletePermission(String id) throws NeuronBootException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new NeuronBootException("未找到菜单信息");
		}
	...
	public void deletePermissionLogical(String id) throws NeuronBootException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new NeuronBootException("未找到菜单信息");
		}
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void addPermission(SysPermission sysPermission) throws NeuronBootException {
		//----------------------------------------------------------------------
		//判断是否是一级菜单，是的话清空父菜单
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void editPermission(SysPermission sysPermission) throws NeuronBootException {

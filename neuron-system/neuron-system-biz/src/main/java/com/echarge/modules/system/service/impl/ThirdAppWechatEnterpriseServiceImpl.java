...
import com.echarge.common.util.RestUtil;
...
import com.echarge.modules.system.vo.thirdapp.JwDepartmentTreeVo;
import com.echarge.modules.system.vo.thirdapp.JwSysUserDepartVo;
...
//    }
    ...
    public SysUser oauth2Login(String code,Integer tenantId) {
        ...
        if (null != map) {
            ...
            if (thirdAccount != null) {
                ...
                throw new NeuronBootException("该用户尚未同步，请同步后再次登录！");
            }
        }
        return null;
    }
    ...
    public JwSysUserDepartVo getThirdUserByWechat(Integer tenantId) {
        ...
        String accessToken = this.getAccessToken();
        if (accessToken == null) {
            throw new NeuronBootException("accessToken获取失败！");
        }
        //获取当前租户下的用户
        ...
        if(oConvertUtils.isEmpty(qwUsers)){
            throw new NeuronBootException("企业微信下没查询到用户！");
        }

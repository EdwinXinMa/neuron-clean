...
import com.echarge.common.util.FillRuleUtil;
import com.echarge.common.util.oConvertUtils;
import com.echarge.modules.system.entity.SysCategory;
import com.echarge.modules.system.mapper.SysCategoryMapper;
import com.echarge.modules.system.model.TreeSelectModel;
import com.echarge.modules.system.service.ISysCategoryService;
...
public class SysCategoryServiceImpl extends ServiceImpl<SysCategoryMapper, SysCategory> implements ISysCategoryService {
	...
	@Override
	public List<TreeSelectModel> queryListByCode(String pcode) throws NeuronBootException{
		...
		if(oConvertUtils.isNotEmpty(pcode)) {
			...
			if(list==null || list.size() ==0) {
				throw new NeuronBootException("该编码【"+pcode+"】不存在，请核实!");
			}
			if(list.size()>1) {
				throw new NeuronBootException("该编码【"+pcode+"】存在多个，请核实!");
			}

package com.echarge.modules.message.handle.impl;
...
import com.echarge.common.constant.enums.Vue3MessageHrefEnum;
import com.echarge.modules.message.handle.ISendMsgHandle;
...
public class SystemSendMsgHandle implements ISendMsgHandle {
    ...
    public void sendMsg(String esReceiver, String esTitle, String esContent) {
        if(oConvertUtils.isEmpty(esReceiver)){
            throw  new NeuronBootException("被发送人不能为空");
        }

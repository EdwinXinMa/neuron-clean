...
import com.echarge.common.api.dto.AiragFlowDTO;
import com.echarge.common.api.dto.DataLogDTO;
import com.echarge.common.api.dto.OnlineAuthDTO;
import com.echarge.common.api.dto.PushMessageDTO;
import com.echarge.common.api.dto.message.*;
import com.echarge.common.api.vo.Result;
import com.echarge.common.aspect.UrlMatchEnum;
import com.echarge.common.constant.*;
import com.echarge.common.constant.enums.*;
import com.echarge.common.desensitization.util.SensitiveInfoUtil;
import com.echarge.common.exception.NeuronBootException;
import com.echarge.common.system.api.ISysBaseAPI;
// Use org.jeecg shim interface for hibernate-re jar compatibility

import com.echarge.common.system.query.QueryCondition;
...
import com.echarge.common.util.dynamic.db.FreemarkerParseFactory;
...
import com.echarge.modules.system.util.SecurityUtil;
import com.echarge.modules.system.vo.lowapp.SysDictVo;
...
//		}
	...
	public void sendTemplateAnnouncement(TemplateMessageDTO message) {
		...
		if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
			throw new NeuronBootException("消息模板不存在，模板编码："+templateCode);
		}
...
//			}
	...
	public void sendTemplateMessage(MessageDTO message) {
		...
		if(oConvertUtils.isEmpty(message.getContent())){
			...
			throw new NeuronBootException("发送消息失败,消息内容为空！");
		}
    ...
    public Object runAiragFlow(AiragFlowDTO airagFlowDTO) {
        throw new UnsupportedOperationException("Airag module not available");
    }
	...
	public void uniPushMsgToUser(PushMessageDTO pushMessageDTO) {
		...
		try {
			if(oConvertUtils.isEmpty(jeecgPushUrl) || "''".equals(jeecgPushUrl) || "??".equals(jeecgPushUrl) ){
				log.warn("yml配置项: neuron.unicloud.pushUrl 未设置，APP消息UniPush推送功能未启用！");
				return;
			}
			// 获取推送的用户信息

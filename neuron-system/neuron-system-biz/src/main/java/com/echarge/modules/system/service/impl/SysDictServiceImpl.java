...
import com.echarge.common.system.util.ResourceUtil;
import com.echarge.common.system.vo.DictModel;
import com.echarge.common.system.vo.DictModelMany;
import com.echarge.common.system.vo.DictQuery;
import com.echarge.common.util.CommonUtils;
import com.echarge.common.util.RedisUtil;
import com.echarge.common.util.SqlInjectionUtil;
import com.echarge.common.util.dynamic.db.DbTypeUtils;
import com.echarge.common.util.oConvertUtils;
import com.echarge.config.mybatis.MybatisPlusSaasConfig;
import com.echarge.modules.system.entity.SysDict;
import com.echarge.modules.system.entity.SysDictItem;
import com.echarge.modules.system.mapper.SysDictItemMapper;
import com.echarge.modules.system.mapper.SysDictMapper;
import com.echarge.modules.system.model.DuplicateCheckVo;
import com.echarge.modules.system.model.TreeSelectModel;
import com.echarge.modules.system.security.DictQueryBlackListHandler;
import com.echarge.modules.system.service.ISysDictService;
...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements ISysDictService {
	...
	public boolean duplicateCheckData(DuplicateCheckVo duplicateCheckVo) {
		...
		try{
			...
			throw new NeuronBootException(errorCause);
		}
...
//	}
	...
	public void editDictByLowAppId(SysDictVo sysDictVo) {
		...
		if(null == dict){
			throw new NeuronBootException("字典数据不存在");
		}

    ...
    public void saveDlmReport(String deviceSn, String payload) {
        try {
            ...
            NcDlmHistory history = new NcDlmHistory()
                    ...
                    .setTotalCurrentA(data.has("totalCurrentA") ? getFloat(data, "totalCurrentA") : getFloat(data, "totalCurrent"))
                    .setTotalCurrentB(data.has("totalCurrentB") ? getFloat(data, "totalCurrentB") : 0f)

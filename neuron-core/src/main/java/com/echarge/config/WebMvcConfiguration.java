...
public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        if (neuronBaseConfig.getPath() != null && neuronBaseConfig.getPath().getUpload() != null) {
            resourceHandlerRegistration
                    .addResourceLocations("file:" + neuronBaseConfig.getPath().getUpload() + "//")
                    .addResourceLocations("file:" + neuronBaseConfig.getPath().getWebapp() + "//");
        }

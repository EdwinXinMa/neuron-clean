package com.echarge.common.system.base.controller;
 ...
 */
@Slf4j
public class NeuronController<T, S extends IService<T>> {
    /**issues/2933 NeuronController注入service时改用protected修饰，能避免重复引用service*/
    @Autowired
    protected S service;
    @Resource
    ...
    protected ModelAndView exportXls(HttpServletRequest request, T object, Class<T> clazz, String title) {
        ...
        exportParams.setImageBasePath(neuronBaseConfig.getPath().getUpload());
    ...
    protected ModelAndView exportXlsSheet(HttpServletRequest request, T object, Class<T> clazz, String title,String exportFields,Integer pageNum) {
        ...
        for (int i = 1; i <=count ; i++) {
            ...
            ExportParams exportParams=new ExportParams(title + "报表", "导出人:" + sysUser.getRealname(), title+i,neuronBaseConfig.getPath().getUpload());
    ...
    protected ModelAndView exportXlsForBigData(HttpServletRequest request, T object, Class<T> clazz, String title,Integer pageSize) {
        ...
        mv.addObject(NormalExcelConstants.FILE_NAME, title);
        mv.addObject(NormalExcelConstants.CLASS, clazz);
        ExportParams exportParams = new ExportParams(title + "报表", "导出人:" + sysUser.getRealname(), title, neuronBaseConfig.getPath().getUpload());
        mv.addObject(NormalExcelConstants.PARAMS, exportParams);

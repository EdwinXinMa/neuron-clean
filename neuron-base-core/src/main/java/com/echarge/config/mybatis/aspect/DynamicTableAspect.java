package com.echarge.config.mybatis.aspect;
...
import com.echarge.common.aspect.annotation.DynamicTable;
import com.echarge.common.constant.CommonConstant;
import com.echarge.common.util.SpringContextUtils;
import com.echarge.config.mybatis.ThreadLocalDataHelper;
...
public class DynamicTableAspect {
     ...
     * 定义切面拦截切入点
     */
    @Pointcut("@annotation(com.echarge.common.aspect.annotation.DynamicTable)")

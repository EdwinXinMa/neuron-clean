package com.echarge.config.sign.util;
...
public class SignUtil {
    ...
    private static String getSignatureSecret() {
        NeuronBaseConfig neuronBaseConfig = SpringContextUtils.getBean(NeuronBaseConfig.class);
        String signatureSecret = neuronBaseConfig.getSignatureSecret();
        ...
        if (oConvertUtils.isEmpty(signatureSecret) || signatureSecret.contains(curlyBracket)) {
            throw new NeuronBootException("签名密钥 ${neuron.signatureSecret} 缺少配置 ！！");
        }

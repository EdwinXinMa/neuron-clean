package com.echarge.config.sign.interceptor;

import org.apache.commons.lang3.StringUtils;
import com.echarge.common.constant.TenantConstant;
import com.echarge.common.util.PathMatcherUtil;
import com.echarge.config.NeuronBaseConfig;
import com.echarge.config.filter.RequestBodyReserveFilter;
...
public class SignAuthConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        String signUrls = neuronBaseConfig.getSignUrls();

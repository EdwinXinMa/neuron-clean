package com.echarge.config.sign.aspect;
...
import com.echarge.config.sign.interceptor.SignAuthInterceptor;
...
public class SignatureCheckAspect {
     ...
     */
    @Pointcut("@annotation(com.echarge.config.sign.annotation.SignatureCheck)")

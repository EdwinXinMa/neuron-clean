...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "neuron.elasticsearch", name = "cluster-nodes")
public class NeuronElasticsearchTemplate {
    /** es服务地址 */
    ...
    public NeuronElasticsearchTemplate(@Value("${neuron.elasticsearch.cluster-nodes}") String baseUrl, @Value("${neuron.elasticsearch.check-enabled}") boolean checkEnabled) {
        log.debug("NeuronElasticsearchTemplate BaseURL：" + baseUrl);

...
import com.echarge.common.enums.SentinelErrorInfoEnum;
...
@Slf4j
public class NeuronBootExceptionHandler {
	 ...
	 * 处理自定义异常
	 */
	@ExceptionHandler(NeuronBootBizTipException.class)
	public Result<?> handleNeuronBootBizTipException(NeuronBootBizTipException e){
	 ...
	 * 处理自定义异常
	 */
	@ExceptionHandler(NeuronBoot401Exception.class)
	@ResponseStatus(HttpStatus.UNAUTHORIZED)
	public Result<?> handleNeuronBoot401Exception(NeuronBoot401Exception e){
		log.error(e.getMessage(), e);
		addSysLog(e);

...
import com.echarge.common.aspect.annotation.Dict;
...
public class DictAspect {
    ...
    @Pointcut("(@within(org.springframework.web.bind.annotation.RestController) || " +
            "@within(org.springframework.stereotype.Controller) || @annotation(com.echarge.common.aspect.annotation.AutoDict)) " +
            "&& execution(public com.echarge.common.api.vo.Result com.echarge..*.*(..))")

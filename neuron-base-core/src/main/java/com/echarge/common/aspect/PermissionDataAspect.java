package com.echarge.common.aspect;
...
import com.echarge.common.system.util.NeuronDataAutorUtils;
import com.echarge.common.system.util.JwtUtil;
import com.echarge.common.system.vo.SysPermissionDataRuleModel;
...
public class PermissionDataAspect {
    ...
    @Pointcut("@annotation(com.echarge.common.aspect.annotation.PermissionData)")
    ...
    public Object arround(ProceedingJoinPoint point) throws  Throwable{
        ...
        if(dataRules!=null && dataRules.size()>0) {
            //临时存储
            NeuronDataAutorUtils.installDataSearchConditon(request, dataRules);
            //TODO 微服务情况下也得支持缓存机制
            SysUserCacheInfo userinfo = commonApi.getCacheUser(username);
            NeuronDataAutorUtils.installUserInfo(request, userinfo);
        }
